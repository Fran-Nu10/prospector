...
- **Line-height:** 0.73–0.90 (apretadísimo, innegociable).
...
| heading | 48px | 0.9 | 0.02px | Anton |
| heading-lg | 103px | 0.75 | 0.03px | Anton |
| display | 160px | 0.73 | 0.06px | Anton |
...
- Line-height de display en 0.73–0.75, tracking +0.06em. Es lo que da el cartel gritado.
